...
namespace CONTROL
{
    public class RelatorioTotal
    {
        ...
        public RelatorioTotal(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            this.sender = sender;
            this.e = e;
        }
        ...
        public void Relatorio(string dsc_produto, string data1, string data2, string tipoOperacao)
        {
            ...
            e.Graphics.DrawString(" RELATÓRIO DE PRODUTOS", FonteSubTitulo, Brushes.Black, MargemEsq + 200, 109, new StringFormat());
            ...
            e.Graphics.DrawString("PERIODO DE : "+ data1 + " ATÉ " + data2, FonteNegrito, Brushes.Black, MargemEsq , 140, new StringFormat());           
            e.Graphics.DrawString("OPERAÇÃO: " + tipoOperacao, FonteNegrito, Brushes.Black, MargemEsq + 480, 140, new StringFormat());
