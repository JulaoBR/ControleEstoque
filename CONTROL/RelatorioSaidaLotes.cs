...
namespace CONTROL
{
    public class RelatorioSaidaLotes
    {
        ...
        public void Relatorio(List<ModelProduto> Lista)
        {
            ...
            rinout.e.Graphics.DrawString("Rastreio de Lotes", FonteSubTitulo, Brushes.Black, MargemEsq + 235, 105, new StringFormat());
            ...
            rinout.e.Graphics.DrawString("CLIENTE", FonteNegrito, Brushes.Black, MargemEsq + 80, 170, new StringFormat());
            rinout.e.Graphics.DrawString("PRODUTO", FonteNegrito, Brushes.Black, MargemEsq + 220, 170, new StringFormat());
            rinout.e.Graphics.DrawString("QUANTIDADE", FonteNegrito, Brushes.Black, MargemEsq + 350, 170, new StringFormat());
            rinout.e.Graphics.DrawString("LOTE", FonteNegrito, Brushes.Black, MargemEsq + 470, 170, new StringFormat());
            rinout.e.Graphics.DrawString("CARREGAMENTO", FonteNegrito, Brushes.Black, MargemEsq + 530, 170, new StringFormat());
